    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">医院医疗工作运营系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <!--
                            <el-form-item label="挂号金额" class="input" v-if="tableName=='yisheng'">
                                <el-input v-model="ruleForm.guahaojine" autocomplete="off" placeholder="挂号金额"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="每天挂号数量" class="input" v-if="tableName=='yisheng'">
                                <el-input v-model="ruleForm.guahaoshuliang" autocomplete="off" placeholder="每天挂号数量"  />
                           </el-form-item>
                        -->
                        <!--
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //     return
                            // }
                            // yisheng 中的 挂号金额 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.guahaojine== null ||this.ruleForm.guahaojine== "")){
                            //     this.$message.error("挂号金额不能为空");
                            //     return
                            // }
                            // yisheng 中的 每天挂号数量 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.guahaoshuliang== null ||this.ruleForm.guahaoshuliang== "")){
                            //     this.$message.error("每天挂号数量不能为空");
                            //     return
                            // }
                            // yisheng 中的 科室 判空处理
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/hospital/img/back-img-bg.jpg);
