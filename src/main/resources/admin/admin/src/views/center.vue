  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='挂号金额' prop="guahaojine">
               <el-input v-model="ruleForm.guahaojine"  placeholder='挂号金额' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='每天挂号数量' prop="guahaoshuliang">
               <el-input v-model="ruleForm.guahaoshuliang"  placeholder='每天挂号数量' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 医生 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.guahaojine)&& 'yisheng'==this.flag){
                             this.$message.error('挂号金额不能为空');
                             return
                         }

                         if((!this.ruleForm.guahaoshuliang)&& 'yisheng'==this.flag){
