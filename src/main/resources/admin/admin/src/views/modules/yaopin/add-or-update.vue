    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="药品进价" prop="yaopinJinjiaMoney">
                       <el-input v-model="ruleForm.yaopinJinjiaMoney"
                                 placeholder="药品进价" clearable  :readonly="ro.yaopinJinjiaMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="售价" prop="yaopinNewMoney">
                       <el-input v-model="ruleForm.yaopinNewMoney"
                                 placeholder="售价" clearable  :readonly="ro.yaopinNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="售价" prop="yaopinNewMoney">
                           <el-input v-model="ruleForm.yaopinNewMoney"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="药品功效" prop="yaopinGongxiaoContent">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="药品禁忌" prop="yaopinJinjiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="注意事项" prop="yaopinZhuyiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yaopinJinjiaMoney: [
                              { required: true, message: '药品进价不能为空', trigger: 'blur' },
