...
public class HospitalInformationEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public HospitalInformationEntity() {

	}

	public HospitalInformationEntity(T t) {
		try {
     ...
     * 医院资讯名称
     */
    @ColumnInfo(comment="医院资讯名称",type="varchar(200)")
     ...
     * 医院资讯图片
     */
    @ColumnInfo(comment="医院资讯图片",type="varchar(200)")
     ...
     * 医院资讯类型
     */
    @ColumnInfo(comment="医院资讯类型",type="int(11)")
	...
	@DateTimeFormat
    @ColumnInfo(comment="医院资讯发布时间",type="timestamp")
     ...
     * 医院资讯详情
     */
    @ColumnInfo(comment="医院资讯详情",type="text")
