...
*/
@TableName("gonggao")
public class HospitalInformationView extends HospitalInformationEntity implements Serializable {
	...
	* 医院资讯类型的值
	*/
	@ColumnInfo(comment="医院资讯类型的字典表值",type="varchar(200)")
	private String gonggaoValue;




	public HospitalInformationView() {

	}

	public HospitalInformationView(HospitalInformationEntity gonggaoEntity) {
		try {
