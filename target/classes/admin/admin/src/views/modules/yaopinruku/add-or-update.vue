        ...
        <el-form
            ...
            <input id="yaopinId" name="yaopinId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="入库时间" prop="caozuoTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.caozuoTime" label="入库时间" prop="caozuoTime">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="入库备注" prop="yaopinrukuContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yaopinrukuContent" label="入库备注" prop="yaopinrukuContent">
